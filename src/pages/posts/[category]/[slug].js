...
import {Alert, Breadcrumb, Button, Col, Comment, Divider, Row, Space, Typography} from "antd";
    ...
    return (
        <Row gutter={[16, 16]}>
                ...
                <div className="box">
                    ...
                    <div>
                        <p>
                            ...
                            نکته: برای یادگیری کامل و جزئی بعضی از این موارد نیازمند یک مقاله اختصاصی هست. برای
                            آیتم‌هایی که
                            اینجا بررسی می‌کنیم (هر چند خلاصه هستن)، تا حد امکان سعی می‌کنم کامل و واضح توضیح بدم که اگه
                            قصد
                            یادگیری هم داشته باشین، نیاز شما رو برطرف کنه.
                            و اما تفاوت‌ها. از undefined شروع کنیم:
                        </p>
                        <p>
                            ویژگی‌های منحصر به فرد undefined:

                            undefined یک مقدار پیشفرض برای متغیرهایی هست که مقدار ندارن. یعنی موقع ساختن این متغیر بهش
                            مقدار داده نشده
            ...
            <Col xs={{span: 24}} md={{span: 7}}>
                <Title level={4} className="title">مطالب مرتبط</Title>
            ...
            <Col xs={{span: 24}} md={{span: 17}}>
                ...
                <div className="box mt-3">
                    ...
                    <Comment
                        className="w-100"
                        actions={[
                            <span key="comment-nested-reply-to"><i className="bi bi-reply"/></span>,
                            <span key="comment-nested-Like"><i className="bi bi-heart"/></span>
                        ]}
                        author={'عباس بوعذار'}
                        ...
                        content={
                            <p>
                                سلام خسته نباشید
                                مرسی از مطالب مفید و کاربردی شما
                                میخواستم بدونم آیا شما یک منبع فارسی خوب برای یادگیری جاوا اسکریپت که این زبان رو با
                                جزئیات کامل(حتی کوچکترین نکات) آموزش داده باشه سراغ دارید
                                منظورم اینه که تمام موضوعات و متد ها و بخش و... رو آموزش داده باشه
                            </p>
                        }
